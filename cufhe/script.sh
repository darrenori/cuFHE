...
#nvcc -c $dire/testing.cu
#nvcc -std=c++11 -O3 -w  -I./ -M -o $dire/test_api_gpu.d $dire/testing.cu
#nvcc -std=c++11 -O3 -w  -I./ -c -o $dire/testing.o $dire/testing.cu
#nvcc -std=c++11 -O3 -w  -o $dire/testing $dire/testing.o -Lbin -lcufhe_gpu
